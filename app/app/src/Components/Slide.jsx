...
const ReviewCard = ({ name, username, body, showStars }) => {
  return (
    <figure
      className={cn(
        "relative cursor-pointer overflow-hidden rounded-xl p-4 bg-zinc-800",
...
export function Slide() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-zinc-950
     dabbe before:content-[''] before:absolute before:inset-0 before:border-2 before:border-transparent before:rounded-xl before:pointer-events-none before:border-t-[#0c6074] before:border-r-[#3caabf] before:animate-rotateBorder
    after:content-[''] after:absolute after:inset-0 after:border-10 after:border-transparent after:rounded-xl after:pointer-events-none after:border-b-[#0c6074] after:border-l-[#3caabf] after:animate-rotateBorderReverse">
      <div className="relative z-10 w-full min-h-screen py-8 sm:py-12 lg:py-16 flex flex-col justify-center gap-6 sm:gap-8 lg:gap-12">
        <div className="text-white flex flex-col w-full text-center px-4">
          ...
          <button className="mt-4 sm:mt-6 lg:mt-8 mx-auto px-4 py-2 w-auto sm:w-48 md:w-56 lg:w-64 text-sm sm:text-base lg:text-lg text-black bg-white font-semibold rounded-md shadow-lg transition-all duration-300 hover:bg-gray-100">
